...
export default function Home() {
  ...
  return (
    <div className='container'>
      <Head>
        <title>Avionicstech - 2023上海国际航电技术大会</title>
      ...
      <main className='main'>
            ...
            <SwiperSlide>
              ...
              <div className='video-container'>
                <div className="middle">
                  <h2 className='title'>2023上海国际航电技术大会</h2>
        ...
        <section className='about'>
          <div className="container">
            ...
            <p className='date'>2023年3月16-17日</p>
          </div>
        </section>
        <section className='introduction' id='introduction'>
          <div className="container">
            ...
            <div className="info">
              ...
              <p className='desc'>在科技创新背景下，ATC2023将聚焦数字技术在航空电子领域的未来发展，本届大会主题：“创新变革、推动先进航电技术”。深入探讨航电、机电、飞控、软件等技术前沿，将围绕模块综合化航空电子系统、先进民航驾驶舱集成、通用飞机座舱系统、软件赋能驱动等内容展开交流。</p>
            </div>
          </div>
        </section>
